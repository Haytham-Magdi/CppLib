...
namespace Hcpl
{
	...
	public:
		...
		{
			Hcpl_ASSERT( NULL != FixedVectorDebug::FixedVectorID_Arr );
		...
		static void ActivateID( int a_nID ) 
		{
			...
			Hcpl_ASSERT( a_nID < FixedVectorID_Arr_Size );

			Hcpl_ASSERT( -1 == FixedVectorID_Arr[ a_nID ] );
		...
		static void DeactivateID( int a_nID ) 
		{
			...
			Hcpl_ASSERT( 100 == FixedVectorID_Arr[ a_nID ] );

			//if( CycleNum > 0 )
				Hcpl_ASSERT( CycleNum == FixedVectorID_Cycle_Arr[ a_nID ] );
				//Hcpl_ASSERT( CycleNum - 1 == FixedVectorID_Cycle_Arr[ a_nID ] );
				//Hcpl_ASSERT( CycleNum - 1 != FixedVectorID_Cycle_Arr[ a_nID ] );
