...
namespace Hcv
{
	...
	RegionSegmentor12::RegionSegmentor12(S16ImageRef a_src, S16ImageRef a_rootImg,
		int a_nDifThreshold) : 
	...
	void RegionSegmentor12::InitRgnInfoVect(void)
	{
	...
	inline void RegionSegmentor12::CreateLink( RgnInfo * a_pRgn, 
	...
	void RegionSegmentor12::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor12::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor12::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor12::Segment()
	{
		int nMaxConfCnt = 0;
...
NoConflict:
	...
	int RegionSegmentor12::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor12::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor12::GenSegmentedImage(void)
	{
...
/*
	void RegionSegmentor12::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	void RegionSegmentor12::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor12::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		bool bRet = false;
	...
	void RegionSegmentor12::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor12::PrepareRgnLinkActions( RgnInfo * a_pRgn )
	{
	...
	S16ImageRef RegionSegmentor12::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor12::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2 )
	{
