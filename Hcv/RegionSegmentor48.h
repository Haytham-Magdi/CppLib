...
/*
	class IRegionSegmentor48 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor48 > IRegionSegmentor48Ref;
*/


	class RegionSegmentor48 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		public:
			...
			ImgDataElm_C7 * pDataElm;

			ImgDataElm_C7 dataElm_Mean;
		...
		public:
			...
			EdgeInfoAccessor( RegionSegmentor48 * a_pSgm )
			{
				m_pSgm = a_pSgm;
	...
	public:
		RegionSegmentor48(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor48::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor48::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	protected:
		...
		ImgDataElm_C7 * m_dataElm_Buf;

		ImgDataElm_C7 * m_dataElm_Mean_Buf;
	...
	typedef Hcpl::ObjRef< RegionSegmentor48 > RegionSegmentor48Ref;
}