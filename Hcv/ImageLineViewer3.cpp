...
namespace Hcv
{
	...
	ImageLineViewer3::ImageLineViewer3( F32ImageRef a_srcImg, LinePathRef a_lp  ) : 
	...
	F32ImageRef ImageLineViewer3::GetResultImg()
	{

		return m_resImg;
	}

	U8ImageRef ImageLineViewer3::GetSignalDspImg()
	{
	...
	void ImageLineViewer3::DoPrepare()
	{
		InitRgnInfoVect();
...
*/
	...
	int ImageLineViewer3::AddFilter( ColorFilter1DSystemBuilder * pFiltSysBld, 
	...
	int ImageLineViewer3::AddColorToSingleConverter( ColorFilter1DSystemBuilder * pFiltSysBld, 
	...
	void ImageLineViewer3::InitRgnInfoVect()
	{
	...
	void ImageLineViewer3::DoProcess()
	{
	...
	void ImageLineViewer3::ReceiveFilterOutput( int a_nFilterID, F32ColorVal a_outVal, int a_nBackShift )
	{
	...
	void ImageLineViewer3::ReceiveFilterOutput( int a_nFilterID, float a_outVal, int a_nBackShift )
	{
		IFilterOutputMgrRef outMgr = m_filterOutputMgrVect[ a_nFilterID ];
	...
	void ImageLineViewer3::NotifyAllOutputDone( )
	{

	}


	void ImageLineViewer3::ColorOutputMgr::ProcessOutput( int a_nFilterID, F32ColorVal a_outVal, int a_nBackShift )
	{
	...
	void ImageLineViewer3::ColorOutputMgr::ProvideSignal( Signal1DViewerRef a_sv )
	{
		...
		*/
		...
		a_sv->AddSignal( m_sb0->GetResult(), m_valColor0, 0.5 );
		a_sv->AddSignal( m_sb1->GetResult(), m_valColor1, 0.5 );
		a_sv->AddSignal( m_sb2->GetResult(), m_valColor2, 0.5 );		
	}



	void ImageLineViewer3::SingleOutputMgr::ProcessOutput( int a_nFilterID, float a_outVal, int a_nBackShift )
	{
		ProcessInner( a_nFilterID, a_outVal, a_nBackShift );
	...
	void ImageLineViewer3::SingleOutputMgr::ProvideSignal( Signal1DViewerRef a_sv )
	{
		ProvideInnerSignal( a_sv );

		//a_sv->AddSignal( m_sb->GetResult(), u8ColorVal(0, 128, 255) );
		a_sv->AddSignal( m_sb->GetResult(), m_color, 0.5 );
	}




	void ImageLineViewer3::Diff1MarkerOutputMgr::ProcessOutput( 
...
/*
	...
	void ImageLineViewer3::Diff2MarkerOutputMgr::ProcessOutput( 
		int a_nFilterID, float a_outVal, int a_nBackShift )
	{
		ProcessInner( a_nFilterID, a_outVal, a_nBackShift );
	...
	void ImageLineViewer3::DoProcessEdges()
	{
	...
	//RgnInfo * ImageLineViewer3::FindRootRgnBef( RgnInfo * a_pEdgeRgnBef, RgnInfo * a_pEdgeRgn )
	ImageLineViewer3::RgnInfo * ImageLineViewer3::FindRootRgnBef( ImageLineViewer3::RgnInfo * a_pEdgeRgn )
	{
		...
		{
			ImageLineViewer3::RgnInfo * pRootRgnAft = m_rootRgnPtrVect[ m_rootIdx ];
	...
	//RgnInfo * ImageLineViewer3::FindRootRgnAft( RgnInfo * a_pEdgeRgn , RgnInfo * a_pEdgeRgnAft)
	ImageLineViewer3::RgnInfo * ImageLineViewer3::FindRootRgnAft( int a_limIOL )
	{
		if( -1 == a_limIOL )
		{
	...
	void ImageLineViewer3::DrawCircle( RgnInfo * a_pRgn, U8ColorVal a_color )
	{
