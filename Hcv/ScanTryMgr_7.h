...
namespace Hcv
{
	...
	class ScanTryMgr_7 : public virtual EdgeScanMgr
	{
	public:
	...
	public:
		...
		ScanTryMgr_7( int a_x, int a_y );

//--		ScanTryMgr_7( F32ImageRef a_src );
		ScanTryMgr_7( IImgDataMgrRef a_src, int a_nDiameter );
	...
	typedef Hcpl::ObjRef< ScanTryMgr_7 > ScanTryMgr_7Ref;
