...
namespace Hcv
{
	...
	class ZeroCrossing_2_Filt1D2 : public LinearSingFilt1D2Base
	{
	public:

		ZeroCrossing_2_Filt1D2( int a_nAprSizOrg, ISingFilt1D2DataReaderRef a_dif2Rdr,
	...
	typedef Hcpl::ObjRef< ZeroCrossing_2_Filt1D2 > ZeroCrossing_2_Filt1D2Ref;
