...
/*
	class IRegionSegmentor27 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor27 > IRegionSegmentor27Ref;
*/


	class RegionSegmentor27 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		{
		public:
			BadRootAssignMgr( RegionSegmentor27 * a_pSegmentor );
		...
		protected:
			...
			//const RegionSegmentor27 * m_pSegmentor;
			RegionSegmentor27 * m_pSegmentor;
	...
	public:
		RegionSegmentor27(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor27::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor27::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor27 > RegionSegmentor27Ref;
}