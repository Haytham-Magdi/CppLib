...
namespace Hcv
{
	...
	ZeroCrossingFilt1D2::ZeroCrossingFilt1D2( int a_nAprSizOrg, ISingFilt1D2DataReaderRef a_dif2Rdr,
	...
	void ZeroCrossingFilt1D2::Proceed_0()
	{
		SetupOutputMgr();
	...
	void ZeroCrossingFilt1D2::Proceed()
	{
		SetupOutputMgr();
