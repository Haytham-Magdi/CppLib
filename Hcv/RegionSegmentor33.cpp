...
namespace Hcv
{
	...
	//RegionSegmentor33::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor33::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor33::RegionSegmentor33(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor33::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor33::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor33::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor33::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor33::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor33::Segment()
	{
...
*/
	...
	float RegionSegmentor33::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor33::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor33::GenSegmentedImage( bool a_bShowMeanColor )
	{
	...
	F32ImageRef RegionSegmentor33::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor33::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor33::ShowSrcPath(int a_x, int a_y)
	{
		//a_x = 266;
		//a_y = 426;
	...
	void RegionSegmentor33::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor33::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	RegionSegmentor33::LinkAction * RegionSegmentor33::CloneLinkAction(LinkAction * a_pLA )
	{
		LinkAction * pLA = &m_linkActionVect[ m_nofLinkActions++ ];
	...
	RegionSegmentor33::LinkAction * RegionSegmentor33::ProvideLinkAction( 
		//RegionSegmentor33::RgnInfo * a_pRgn, RegionSegmentor33::RgnInfo * a_pRgn2 )
	...
	RegionSegmentor33::LinkAction * RegionSegmentor33::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		//ThrowHcvException();
	...
	void RegionSegmentor33::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
...
*/
	...
	bool RegionSegmentor33::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor33::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor33::RgnConflict * RegionSegmentor33::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor33::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor33::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor33::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor33::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor33::CreateConf_WithTrace( RgnInfo * a_pRgn1, EdgeScan::EdgeInfo * a_pEI )
	{
	...
	void RegionSegmentor33::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor33::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor33::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor33::ScanImageLines()
	{
...
//*/
	...
	F32ImageRef RegionSegmentor33::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor33::GenBadSrcImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor33::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor33::GenRgnRootDifImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	void RegionSegmentor33::ResetBadSrcWork()
	{
	...
	void RegionSegmentor33::MarkRgnsFromBadSrc()
	{
		RgnInfo * pTestRgn = & m_rgnInfoVect[ m_nTestRgnIdx ];
...
/////////////////////////////////////////////
	...
	F32ImageRef RegionSegmentor33::Gen_FalseMergeImage_2()
	{
		F32ImageRef ret = this->m_src->Clone();
		...
		for( int i=0; i < m_rgnInfoVect.GetSize(); i++ )
		{
			...
			if( pRgn->bFromBadSrc && pRgn->IsRoot() )
	...
	F32ImageRef RegionSegmentor33::Gen_FalseMergeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor33::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor33::PrepareSrcGradImg()
	{
