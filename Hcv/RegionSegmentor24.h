...
/*
	class IRegionSegmentor24 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor24 > IRegionSegmentor24Ref;
*/


	class RegionSegmentor24 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		{
		public:
			BadRootAssignMgr( RegionSegmentor24 * a_pSegmentor );
		...
		protected:
			...
			//const RegionSegmentor24 * m_pSegmentor;
			RegionSegmentor24 * m_pSegmentor;
	...
	public:
		RegionSegmentor24(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor24::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor24::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor24 > RegionSegmentor24Ref;
}