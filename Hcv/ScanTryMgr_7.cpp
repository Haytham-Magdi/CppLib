...
namespace Hcv
{
	...
	void ScanTryMgr_7::PrepareEnv( IImgDataMgrRef a_src, int a_nDif_Diameter )
	{
	...
	void ScanTryMgr_7::FillLineData( Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		a_sli->GotoFirst();
...
//uuuuuuuuuuuuuuuuuu
	...
	void ScanTryMgr_7::Show_Edges_Roots( )
	{
		float * angDifBuf = m_angDifData->GetData();
...
//			)->GetPixAt(0, 0);
	...
	void ScanTryMgr_7::DspLineOnImg( int a_x, int a_y,
...
//--		F32ImageRef dspImg = m_src->Clone();
	...
	//void ScanTryMgr_7::ValidateDiameter( int a_nDiameter )
	void ScanTryMgr_7::ValidateDiameter( )
	{
	...
	ScanTryMgr_7::ScanTryMgr_7( int a_x, int a_y )
	{
...
//--		PrepareEnv( GlobalStuff::GetLinePathImg() );
		...
		IImgDataMgrRef dm1 = new ImgDataMgr_C7(			
	...
	ScanTryMgr_7::ScanTryMgr_7( IImgDataMgrRef a_src, int a_nDiameter )
	{
		//m_nDiameter = GlobalStuff::AprSize1D;
...
*/
	...
	void ScanTryMgr_7::ScanSli( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		//PrepareAperSizes();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_7::GetEI_Of_Pix( int a_x, int a_y,
		int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_7::GetEI_Of_Pix( int a_nPI, int a_nDir )
	{
	...
	void ScanTryMgr_7::ScanPntDir( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
	...
	void ScanTryMgr_7::Find_Edges_Roots( int a_x, int a_y )
	{
		ImgGradMgr_2 & igm1 = *m_imgGradMgr;
		//ImgAvgingMgr & igm1 = *m_imgGradMgr;
	...
	void ScanTryMgr_7::PostProcScanLine( Ns_ImgGradMgr::ScanLineItrRef a_sli,
...
DoesConflict_Done:
	...
	EdgeScanMgr::DataDraw * ScanTryMgr_7::AddSigDraw( ISingFilt1D2Ref a_filt, 
	...
	void ScanTryMgr_7::PrepareFiltSys()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_7::PrepareFiltSys_Thesis()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_7::PrepareFiltSys_Thesis_2()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_7::PrepareFiltSys_2()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_7::PrepareAperSizes()
	{
	...
	void ScanTryMgr_7::PrepareDeepRoots()
	{
		//int nDeepCnt = 0;
//		int nDeepCnt = 1;
		int nDeepCnt = 2;
	...
	void ScanTryMgr_7::PostProcessEI_Arr_2()
	{
		PrepareDeepRoots();
...
////////////////////////////////////////////////////////////////////////////////

				{
					...
					if( u_Dif_D1_D2 < ImgDataElm_C7::Get_FarUnitDif() &&
						u_Dif_R1_R2 < ImgDataElm_C7::Get_FarUnitDif() )
					{
...
////////////////////////////////////////////////////////////////////////////////
	...
	F32ImageRef ScanTryMgr_7::GenSlopeImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_7::GenFinDifImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_7::GenMaxSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_7::GenMinSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
