...
*/
		...
		void PrepareScanLineItr( Ns_ImgGradMgr::ScanLineItrRef a_sli, 
			int a_nPI, int a_nDir );
		...
		ImgGradMgr_2( IImgDataMgrRef a_src, int a_nAprSiz, int a_nofDirs );
	...
	typedef Hcpl::ObjRef< ImgGradMgr_2 > ImgGradMgr_2Ref;
