...
namespace Hcv
{
	...
	class RegionSegmentor4 : FRM_Object
	{
	protected:
	...
	public:
		RegionSegmentor4(S16ImageRef a_src, int a_nDifThreshold = 15);
	...
	protected:
		...
		const int m_nColorScale;
	};


	typedef Hcpl::ObjRef< RegionSegmentor4 > RegionSegmentor4Ref;
}