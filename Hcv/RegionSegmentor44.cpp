...
namespace Hcv
{
	...
	//RegionSegmentor44::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor44::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor44::RegionSegmentor44(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor44::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor44::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor44::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor44::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor44::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor44::Segment()
	{
		//m_pDbgRgn = & m_rgnInfoVect[ 110507 ];
...
//if( e < nLim_e - 1 )
	...
	float RegionSegmentor44::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor44::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor44::GenSegmentedImage( bool a_bShowMeanColor )
	{
		//Gen_SegData();
	...
	F32ImageRef RegionSegmentor44::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor44::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor44::ShowSrcPath(int a_x, int a_y)
	{
		//a_x = 266;
		//a_y = 426;
	...
	void RegionSegmentor44::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor44::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	//RegionSegmentor44::LinkAction * RegionSegmentor44::CloneLinkAction(LinkAction * a_pLA )
	//{
	...
	RegionSegmentor44::LinkAction * RegionSegmentor44::ProvideLinkAction( 
		//RegionSegmentor44::RgnInfo * a_pRgn, RegionSegmentor44::RgnInfo * a_pRgn2 )
	...
	RegionSegmentor44::LinkAction * RegionSegmentor44::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		//ThrowHcvException();
	...
	void RegionSegmentor44::PrepareLinkAction( 
...
*/
	...
	void RegionSegmentor44::Push_LA_To_MergeQues( int a_nIndex, LinkAction * pLA )
	{
		pLA->bIsActive = true;
	...
	RegionSegmentor44::LinkAction * RegionSegmentor44::PopMinPtr_From_MergeQues()
	{
		PopPtr:
	...
	RegionSegmentor44::LinkAction * RegionSegmentor44::PopMaxPtr_From_MergeQues()
	{
		PopPtr:
	...
	bool RegionSegmentor44::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor44::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor44::RgnConflict * RegionSegmentor44::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor44::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor44::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor44::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor44::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor44::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge, EdgeScan::EdgeInfo * a_pEI )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor44::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor44::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor44::PostScanPrepare()
	{
	...
	void RegionSegmentor44::ScanImageLines()
	{
...
/////////////////////////
		...
		m_scanTryMgr = new ScanTryMgr_5( m_imgDataMgr, m_nAprSize );
		//m_scanTryMgr = new ScanTryMgr_5( m_src );
		...
		float * standDiv_Buf = m_scanTryMgr->GetStandDiv_Buf();
...
/////////--------------------------------------------
	...
	RegionSegmentor44::RgnLink * RegionSegmentor44::GetLinkBetweenRgns( int a_nIdx_1, int a_nIdx_2 )
	{
	...
	F32ImageRef RegionSegmentor44::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor44::GenBadSrcImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor44::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor44::GenTraceDamImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor44::GenRgnRootDifImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	void RegionSegmentor44::ResetBadSrcWork()
	{
		Hcpl_ASSERT( false );
	...
	void RegionSegmentor44::MarkRgnsFromBadSrc()
	{
		RgnInfo * pTestRgn = & m_rgnInfoVect[ m_nTestRgnIdx ];
...
//*/
	...
	F32ImageRef RegionSegmentor44::Gen_FalseMergeImage_2()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor44::Gen_FalseMergeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor44::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor44::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor44::Manage_EI_Activation( RgnInfo * a_pRgn_1, RgnInfo * a_pRgn_2 )
	{
		return;
	...
	void RegionSegmentor44::Gen_SegData()
	{
				...
				
		{
			...
			*((int *)(& fileData_Arr[ nCnt ])) = nofSegments;
...

			{
				...
				int nSiz_2 = ( pixInt_Arr.GetSize() * 4 );
			...
			{
				sFilePath = 
					"E:\\HthmWork\\Lib\\BSDS_300_2\\CBIS\\Segms\\";
