...
namespace Hcv
{
	...
	CircleContourOfPix2::CircleContourOfPix2( F32ImageRef a_srcImg, F32ImageRef a_gradImg, int a_radius )		
	{
	...
	void CircleContourOfPix2::InitDirArr()
	{
	...
	void CircleContourOfPix2::PreparePix( int a_x, int a_y )
	{
		m_x = a_x;
		m_y = a_y;
...
*/
	...
	void CircleContourOfPix2::ShowResult()
	{
...
*/
	...
	void CircleContourOfPix2::ShowValArrSignal( FixedVector< float > & a_valArr, char * a_sWndName )
	{
...
*/
	...
	void CircleContourOfPix2::PrepareValArr2( )
	{
