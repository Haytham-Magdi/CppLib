...
namespace Hcv
{
	...
	class IRegionSegmentor20 : FRM_Object
	{	
	public:
		...
		virtual void ShowValleyPath(int a_x, int a_y) { throw "Nothing!"; }
		virtual void ShowSrcPath(int a_x, int a_y) { throw "Nothing!"; }

		virtual ~IRegionSegmentor20() 
		{
		}
	};

	typedef Hcpl::ObjRef< IRegionSegmentor20 > IRegionSegmentor20Ref;



	class RegionSegmentor20 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
/*			struct _TraceUnit()
	...
	public:
		RegionSegmentor20(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	typedef Hcpl::ObjRef< RegionSegmentor20 > RegionSegmentor20Ref;
}