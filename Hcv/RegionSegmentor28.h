...
/*
	class IRegionSegmentor28 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor28 > IRegionSegmentor28Ref;
*/


	class RegionSegmentor28 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		{
		public:
			BadRootAssignMgr( RegionSegmentor28 * a_pSegmentor );
		...
		protected:
			...
			//const RegionSegmentor28 * m_pSegmentor;
			RegionSegmentor28 * m_pSegmentor;
	...
	public:
		RegionSegmentor28(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor28::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor28::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor28 > RegionSegmentor28Ref;
}