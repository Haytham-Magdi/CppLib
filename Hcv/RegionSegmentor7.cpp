...
namespace Hcv
{
	...
	RegionSegmentor7::RegionSegmentor7(S16ImageRef a_src, int a_nDifThreshold) : 
	...
	void RegionSegmentor7::InitRgnInfoVect(void)
	{
	...
	inline void RegionSegmentor7::CreateLink( RgnInfo * a_pRgn, 
	...
	void RegionSegmentor7::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor7::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor7::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor7::UpdateMasterRgn( 
	...
	int RegionSegmentor7::CalcColorDif( 
...
/*	int RegionSegmentor7::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
		int nDist = (int) sqrt( (double) (
	...
	int RegionSegmentor7::CalcRgnMeanDif(RgnInfo * a_pActRgn1, RgnInfo * a_pActRgn2)
	{
		int nDist = (int) sqrt( (double) (
	...
	void RegionSegmentor7::_RgnInfo::UpdateActRgn()
	{
		RgnInfo * a_pRgn = this;
	...
	S16ImageRef RegionSegmentor7::GenSegmentedImage(void)
	{
...
/*		for(int i=0; i < m_rgnInfoVect.size(); i++)
	...
	void RegionSegmentor7::PrepareConflicts()
	{
		// To be Revised
...
//				pRgn = pRgn;
	...
	void RegionSegmentor7::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor7::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
	...
	void RegionSegmentor7::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor7::PrepareRgnLinkActions( RgnInfo * a_pRgn )
	{
	...
	S16ImageRef RegionSegmentor7::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	S32ColorVal RegionSegmentor7::GetLocalMeanColor( 
	...
	S32ColorVal RegionSegmentor7::_RgnInfo::GetLocalMeanColor()
	{
		S32ColorVal ret;
	...
	void RegionSegmentor7::PrepareFarConflicts( RgnInfo * a_pRgn, 
