...
namespace Hcv
{
	...
	class CircleContourOfPix3 : FRM_Object
	{
	public:

		CircleContourOfPix3( F32ImageRef a_srcImg, F32ImageRef a_gradImg, int a_radius );
	...
	typedef Hcpl::ObjRef< CircleContourOfPix3 > CircleContourOfPix3Ref;
