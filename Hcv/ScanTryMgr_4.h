...
namespace Hcv
{
	...
	class ScanTryMgr_4 : public virtual EdgeScanMgr
	{
	public:
	...
	public:
		...
		ScanTryMgr_4( int a_x, int a_y );

//--		ScanTryMgr_4( F32ImageRef a_src );
		ScanTryMgr_4( IImgDataMgrRef a_src );
	...
	typedef Hcpl::ObjRef< ScanTryMgr_4 > ScanTryMgr_4Ref;
