...
namespace Hcv
{
	...
	//RegionSegmentor21::MgrOfLinkTypes::CoreStuff m_core;

	RegionSegmentor21::RegionSegmentor21(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor21::InitRgnInfoVect(void)
	{
...
/*					if(nRootImgVal > 1)
	...
	inline void RegionSegmentor21::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor21::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor21::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor21::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor21::Segment()
	{
...
NoTraceProblem:
	...
	float RegionSegmentor21::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor21::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor21::GenSegmentedImage( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor21::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor21::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	RegionSegmentor21::LinkAction * RegionSegmentor21::CloneLinkAction(LinkAction * a_pLA )
	{
		LinkAction * pLA = &m_linkActionVect[ m_nofLinkActions++ ];
	...
	RegionSegmentor21::LinkAction * RegionSegmentor21::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		int x = a_pRgn->pos.x;
		int y = a_pRgn->pos.y;
	...
	void RegionSegmentor21::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor21::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor21::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor21::RgnConflict * RegionSegmentor21::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor21::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor21::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor21::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor21::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor21::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge )
	{
		if( NULL == a_pOrgEdge )
	...
	void RegionSegmentor21::ProcessEdgeQues()
	{
			LinkAction * pLA = NULL;
...
*/
	...
	void RegionSegmentor21::PrepareTraceListPtrs()
	{
		{
	...
	void RegionSegmentor21::TraceLinkActionRoots( LinkAction * a_pLA)
...
/*				unitColorDist = F32ColorVal::Sub(
	...
	void RegionSegmentor21::ProcessLinkActionTrace( LinkAction * a_pLA )
	{
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor21::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor21::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor21::ScanImageLines()
	{
...
*/
				...
				for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
				{
					...
					CreateConflict( rEI.pRgnR1, rEI.pRgnR2, rEI.pEdgeRgn );
