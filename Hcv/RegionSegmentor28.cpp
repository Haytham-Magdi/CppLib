...
namespace Hcv
{
	...
	//RegionSegmentor28::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor28::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor28::RegionSegmentor28(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor28::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor28::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor28::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor28::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor28::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor28::Segment()
	{
...
*/
	...
	float RegionSegmentor28::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor28::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor28::GenSegmentedImage( bool a_bShowMeanColor )
	{
	...
	F32ImageRef RegionSegmentor28::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor28::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor28::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor28::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	RegionSegmentor28::LinkAction * RegionSegmentor28::CloneLinkAction(LinkAction * a_pLA )
	{
		LinkAction * pLA = &m_linkActionVect[ m_nofLinkActions++ ];
	...
	RegionSegmentor28::LinkAction * RegionSegmentor28::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		ThrowHcvException();
...
*/
	...
	void RegionSegmentor28::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
...
/*	
	...
	bool RegionSegmentor28::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor28::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor28::RgnConflict * RegionSegmentor28::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor28::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor28::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor28::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor28::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor28::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor28::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor28::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor28::ActivateNonConfRoots()
	{
...
*/
	...
	void RegionSegmentor28::ScanImageLines()
	{
...
*/
	...
	void RegionSegmentor28::FilterByLocalGrad()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	F32ImageRef RegionSegmentor28::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor28::GenNearEdgeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor28::GenBadRootImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	void RegionSegmentor28::PrepareLocalGrad( )
	{
	...
	void RegionSegmentor28::FilterByNearEdgeRoots()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	void RegionSegmentor28::MarkNearEdgeRgns()
	{
...
*/
	...
	void RegionSegmentor28::MarkNearEdgeRgns2()
	{
		static int dxArr[] = {1, 1, 0, -1};
		static int dyArr[] = {0, 1, 1, 1};
...
*/
	...
	RegionSegmentor28::RgnInfo * RegionSegmentor28::GetDeepValleyRgn( RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		{
			F32Point p1( 105, 105 );
...
*/
	...
	bool RegionSegmentor28::GetNextValleyRgn( RgnInfo * a_pRgn, RgnInfo ** a_ppOutRgn, 
	...
	void RegionSegmentor28::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	F32ImageRef RegionSegmentor28::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor28::GenBadEdgeImage()
	{
...
*/					
	...
	F32ImageRef RegionSegmentor28::GenLocalGradValImage()
	{
		//F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor28::GenLocalGradImage()
	{
...
*/
	...
	void RegionSegmentor28::AssignTraceIntersections()
	{
		static int dxArr[] = {1, 1, 0, -1};
		static int dyArr[] = {0, 1, 1, 1};
	...
	F32ImageRef RegionSegmentor28::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor28::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor28::PrepareValidEdgeDirs()
	{
		const int nRadius = 4;
	...
	void RegionSegmentor28::AssignBadRoots()
	{
	...
	RegionSegmentor28::BadRootAssignMgr::BadRootAssignMgr( RegionSegmentor28 * a_pSegmentor ) :
	...
	void RegionSegmentor28::BadRootAssignMgr::Proceed()
	{
		ScanImageLines();
	...
	void RegionSegmentor28::BadRootAssignMgr::ScanImageLines()
	{
		//CvSize siz1 = m_src->GetSize();
		CvSize siz1 = m_pSegmentor->m_maxPostDiffImg->GetSize();
		//CvSize siz1 = ( (RegionSegmentor28 *) m_pSegmentor)->m_maxPostDiffImg->GetSize();
...
/////////  NeDiag
	...
	void RegionSegmentor28::BadRootAssignMgr::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	void RegionSegmentor28::BadRootAssignMgr::MarkNearPeakRgns()
	{
