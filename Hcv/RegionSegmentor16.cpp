...
namespace Hcv
{
	...
	RegionSegmentor16::RegionSegmentor16(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor16::InitRgnInfoVect(void)
	{
	...
	inline void RegionSegmentor16::CreateLink( RgnInfo * a_pRgn, 
...
/*		if( pRgn2->bIsEdge )
	...
	void RegionSegmentor16::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor16::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor16::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor16::Segment()
	{
		int nMaxConfCnt = 0;
		...
		interRootQues.Init( m_difQues.GetNofQues() );
...
/*					if(	NULL != ( pLA = tmpQue.PopPtr() ) )
				...
				if( 0 == i )
				{
					if( NULL != pRootRgn1 && NULL != pRootRgn2 )
					{
						...
						else // if( 0 == i )
						{
							...
							interRootQues.PushPtr(nDist, pLA );
	...
	int RegionSegmentor16::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
		int nDist = (int) ( m_difScale * sqrt( (double) (
		//int nDist = (int) ( (
	...
	// With Space
	int RegionSegmentor16::CalcRgnDifWS(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
		double spaceFact = 1;
...
/*		if( distSpace > 15 )
	...
	void RegionSegmentor16::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor16::GenSegmentedImage(void)
	{
...
/*
	void RegionSegmentor16::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	void RegionSegmentor16::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
...
/*		if( a_pRgn2->bIsEdge )
	...
	bool RegionSegmentor16::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		bool bRet = false;
	...
	void RegionSegmentor16::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor16::PrepareRgnLinkActions( RgnInfo * a_pRgn, int a_nDistBef )
	{
	...
	S16ImageRef RegionSegmentor16::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor16::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2 )
	{
