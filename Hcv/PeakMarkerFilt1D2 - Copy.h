...
namespace Hcv
{
	...
	class PeakMarkerFilt1D2 : public LinearSingFilt1D2Base
	{
	public:

		PeakMarkerFilt1D2( int a_nAprSizOrg, ISingFilt1D2DataReaderRef a_difRdr,
	...
	protected:
		...
		float CalcNearMax( float a_maxVal )
		{
			...
			return ( multVal > subVal ) ? multVal : subVal;
		}
	...
	typedef Hcpl::ObjRef< PeakMarkerFilt1D2 > PeakMarkerFilt1D2Ref;
