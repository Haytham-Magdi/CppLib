...
namespace Hcv
{
	...
	void CompositeColorFilter1D::InputVal(F32ColorVal a_val)
	{
	...
	F32ColorVal CompositeColorFilter1D::DoCalcOutput()
	{
		F32ColorVal outVal;
...
/*
	F32ColorVal CompositeColorFilter1D::GetLastOutput()
	{
		F32ColorVal outVal;
...
*/
	...
	bool CompositeColorFilter1D::HasOutput()
	{
		return m_flt0->HasOutput();
	}

	int CompositeColorFilter1D::GetShift()
	{
		return m_flt0->GetShift();
	}

	int CompositeColorFilter1D::GetLength()
	{
		return m_flt0->GetLength();
	}

	void CompositeColorFilter1D::ResetInput()
	{
		m_flt0->ResetInput();
		m_flt1->ResetInput();
		m_flt2->ResetInput();
