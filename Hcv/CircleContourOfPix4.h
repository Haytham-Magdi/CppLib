...
namespace Hcv
{
	...
	class CircleContourOfPix4 : FRM_Object
	{
	public:

		CircleContourOfPix4( F32ImageRef a_srcImg, F32ImageRef a_gradImg, int a_radius );
	...
	typedef Hcpl::ObjRef< CircleContourOfPix4 > CircleContourOfPix4Ref;
