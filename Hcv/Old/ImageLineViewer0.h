...
namespace Hcv
{
	...
	protected:
		...
		{ 
			return m_inputRgnPtrVect[ m_inputRgnPtrVect.size() - 1 - a_nBackShift ]; 
		}
	...
	protected:
		...
		std::vector< RgnInfo * > m_inputRgnPtrVect;

		//std::vector< IFilterOutputMgr * > m_filterOutputMgrVect;
		std::vector< IFilterOutputMgrRef > m_filterOutputMgrVect;
