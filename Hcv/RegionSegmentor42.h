...
/*
	class IRegionSegmentor42 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor42 > IRegionSegmentor42Ref;
*/


	class RegionSegmentor42 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
/*			struct _TraceUnit()
		...
		public:
			...
			struct _RgnInfo * pRgn1;
			struct _RgnInfo * pRgn2;
...
*/
		...
		public:
			...
			void IncPopulationBy( struct _RgnInfo * a_pRgn2 )
			{
		...
		public:
			...
			EdgeInfoAccessor( RegionSegmentor42 * a_pSgm )
			{
				m_pSgm = a_pSgm;
	...
	public:
		RegionSegmentor42(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor42::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor42::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor42 > RegionSegmentor42Ref;
}