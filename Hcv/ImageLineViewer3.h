...
namespace Hcv
{
	...
	class ImageLineViewer3 : public IColorFilter1DSystemConsumer
	{
	...
	protected:
		...
		{
		public:
			FilterOutputMgrBase( ImageLineViewer3 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) : 
		...
		{
		public:
			DummyOutputMgr( ImageLineViewer3 * a_pIlv ) : FilterOutputMgrBase( a_pIlv ) {}
		...
		{
		public:
			ColorOutputMgr( ImageLineViewer3 * a_pIlv,
		...
		{
		public:
			AvgOutputMgr( ImageLineViewer3 * a_pIlv ) : ColorOutputMgr( a_pIlv,
		...
		{
		public:
			SingleOutputMgr( ImageLineViewer3 * a_pIlv, U8ColorVal a_color ) 
...
/*
		...
		{
		public:
			Diff1MarkerOutputMgr( ImageLineViewer3 * a_pIlv, U8ColorVal a_color ) 
...
*/
		...
		{
		public:
			Diff1MarkerOutputMgr( ImageLineViewer3 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) 
		...
		{
		public:
			Diff2MarkerOutputMgr( ImageLineViewer3 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) 
				: FilterOutputMgrBase( a_pIlv, a_inner ) {}
	...
	public:
		...
		ImageLineViewer3( F32ImageRef a_srcImg, LinePathRef a_lp );
	...
	typedef Hcpl::ObjRef< ImageLineViewer3 > ImageLineViewer3Ref;
