...
namespace Hcv
{
	...
	//RegionSegmentor24::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor24::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor24::RegionSegmentor24(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	{	
		...
		{
			m_srcGrad = GenMorphGradImg( m_src, 4 );
	...
	void RegionSegmentor24::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor24::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor24::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor24::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor24::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor24::Segment()
	{
...
*/
	...
	float RegionSegmentor24::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor24::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor24::GenSegmentedImage( bool a_bShowMeanColor )
	{
	...
	F32ImageRef RegionSegmentor24::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor24::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor24::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	RegionSegmentor24::LinkAction * RegionSegmentor24::CloneLinkAction(LinkAction * a_pLA )
	{
		LinkAction * pLA = &m_linkActionVect[ m_nofLinkActions++ ];
	...
	RegionSegmentor24::LinkAction * RegionSegmentor24::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		ThrowHcvException();
...
*/
	...
	void RegionSegmentor24::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor24::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor24::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor24::RgnConflict * RegionSegmentor24::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor24::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor24::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor24::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor24::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor24::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor24::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor24::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor24::ScanImageLines()
	{
...
/////////////////////////
	...
	void RegionSegmentor24::FilterByLocalGrad()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	F32ImageRef RegionSegmentor24::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor24::GenNearEdgeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor24::GenBadRootImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	void RegionSegmentor24::PrepareLocalGrad( )
	{
	...
	void RegionSegmentor24::FilterByNearEdgeRoots()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	void RegionSegmentor24::MarkNearEdgeRgns()
	{
...
*/
	...
	void RegionSegmentor24::MarkNearEdgeRgns2()
	{
...
*/
	...
	void RegionSegmentor24::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	F32ImageRef RegionSegmentor24::GenBadEdgeImage()
	{
...
*/					
	...
	F32ImageRef RegionSegmentor24::GenLocalGradValImage()
	{
		//F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor24::GenLocalGradImage()
	{
...
*/
	...
	void RegionSegmentor24::AssignTraceIntersections()
	{
		static int dxArr[] = {1, 1, 0, -1};
		static int dyArr[] = {0, 1, 1, 1};
	...
	F32ImageRef RegionSegmentor24::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor24::AssignBadRoots()
	{
	...
	RegionSegmentor24::BadRootAssignMgr::BadRootAssignMgr( RegionSegmentor24 * a_pSegmentor ) :
	...
	void RegionSegmentor24::BadRootAssignMgr::Proceed()
	{
		ScanImageLines();
	...
	void RegionSegmentor24::BadRootAssignMgr::ScanImageLines()
	{
		//CvSize siz1 = m_src->GetSize();
		CvSize siz1 = m_pSegmentor->m_maxPostDiffImg->GetSize();
		//CvSize siz1 = ( (RegionSegmentor24 *) m_pSegmentor)->m_maxPostDiffImg->GetSize();
...
/////////  NeDiag
	...
	void RegionSegmentor24::BadRootAssignMgr::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	void RegionSegmentor24::BadRootAssignMgr::MarkNearPeakRgns()
	{
