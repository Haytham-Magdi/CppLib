...
namespace Hcv
{
	...
	//RegionSegmentor46::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor46::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor46::RegionSegmentor46(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor46::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor46::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor46::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor46::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor46::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor46::Segment()
	{
		//m_pDbgRgn = & m_rgnInfoVect[ 110507 ];
...
//if( e < nLim_e - 1 )
	...
	float RegionSegmentor46::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor46::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor46::GenSegmentedImage( bool a_bShowMeanColor )
	{
		//Gen_SegData();
	...
	F32ImageRef RegionSegmentor46::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor46::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor46::ShowSrcPath(int a_x, int a_y)
	{
		//a_x = 266;
		//a_y = 426;
	...
	void RegionSegmentor46::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor46::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	//RegionSegmentor46::LinkAction * RegionSegmentor46::CloneLinkAction(LinkAction * a_pLA )
	//{
	...
	RegionSegmentor46::LinkAction * RegionSegmentor46::ProvideLinkAction( 
		//RegionSegmentor46::RgnInfo * a_pRgn, RegionSegmentor46::RgnInfo * a_pRgn2 )
	...
	RegionSegmentor46::LinkAction * RegionSegmentor46::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		//ThrowHcvException();
	...
	void RegionSegmentor46::PrepareLinkAction( 
...
*/
	...
	void RegionSegmentor46::Push_LA_To_MergeQues( int a_nIndex, LinkAction * pLA )
	{
		pLA->bIsActive = true;
	...
	RegionSegmentor46::LinkAction * RegionSegmentor46::PopMinPtr_From_MergeQues()
	{
		PopPtr:
	...
	RegionSegmentor46::LinkAction * RegionSegmentor46::PopMaxPtr_From_MergeQues()
	{
		PopPtr:
	...
	bool RegionSegmentor46::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor46::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor46::RgnConflict * RegionSegmentor46::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor46::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor46::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor46::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor46::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor46::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge, EdgeScan::EdgeInfo * a_pEI )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor46::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor46::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor46::PostScanPrepare()
	{
	...
	void RegionSegmentor46::ScanImageLines()
	{
...
/////////--------------------------------------------
	...
	RegionSegmentor46::RgnLink * RegionSegmentor46::GetLinkBetweenRgns( int a_nIdx_1, int a_nIdx_2 )
	{
	...
	F32ImageRef RegionSegmentor46::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor46::GenBadSrcImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor46::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor46::GenTraceDamImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor46::GenRgnRootDifImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	void RegionSegmentor46::ResetBadSrcWork()
	{
		Hcpl_ASSERT( false );
	...
	void RegionSegmentor46::MarkRgnsFromBadSrc()
	{
		RgnInfo * pTestRgn = & m_rgnInfoVect[ m_nTestRgnIdx ];
...
//*/
	...
	F32ImageRef RegionSegmentor46::Gen_FalseMergeImage_2()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor46::Gen_FalseMergeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor46::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor46::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor46::Manage_EI_Activation( RgnInfo * a_pRgn_1, RgnInfo * a_pRgn_2 )
	{
		return;
	...
	void RegionSegmentor46::Gen_SegData()
	{
