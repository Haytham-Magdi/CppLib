...
namespace Hcv
{
	...
	RegionSegmentor14::RegionSegmentor14(S16ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor14::InitRgnInfoVect(void)
	{
	...
	inline void RegionSegmentor14::CreateLink( RgnInfo * a_pRgn, 
	...
	void RegionSegmentor14::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor14::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor14::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor14::Segment()
	{
		int nMaxConfCnt = 0;
...
ValidLA :
			...
			if( &m_rgnInfoVect[0] == pLA->pRgn1 ||
				&m_rgnInfoVect[0] == pLA->pRgn2 )			
				pLA = pLA;
...
NoConflict:
	...
	int RegionSegmentor14::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	// With Space
	int RegionSegmentor14::CalcRgnDifWS(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
		double spaceFact = 1;
	...
	void RegionSegmentor14::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor14::GenSegmentedImage(void)
	{
...
/*
	void RegionSegmentor14::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	void RegionSegmentor14::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor14::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		bool bRet = false;
	...
	void RegionSegmentor14::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor14::PrepareRgnLinkActions( RgnInfo * a_pRgn, int a_nDistBef )
	{
		...
		for(int i=0; i<4; i++)
		{
			...
			int nDist = CalcRgnDif( a_pRgn->pRootRgn, pRgn2 );
			//if( nDist > m_nDifThreshold )
			//	nDist = m_nDifThreshold;

			if( nDist > rLink.nDist )
			{
				rLink.nDist = rLink2.nDist = nDist;					
			}
	...
	S16ImageRef RegionSegmentor14::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor14::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2 )
	{
