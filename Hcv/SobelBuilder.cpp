...
namespace Hcv
{
	...
	SobelBuilder::SobelBuilder(F32ImageRef a_src, int a_nAprSiz) :
	...
	F32ImageRef SobelBuilder::GenImageX(int a_nOrder)
	{
	...
	F32ImageRef SobelBuilder::GenImageY(int a_nOrder)
	{
