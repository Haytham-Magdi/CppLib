...
namespace Hcv
{
	...
	void ScanTryMgr_4::PrepareEnv( IImgDataMgrRef a_src, int a_nDif_Diameter )
	{
	...
	void ScanTryMgr_4::FillLineData( Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		a_sli->GotoFirst();
...
//uuuuuuuuuuuuuuuuuu
	...
	void ScanTryMgr_4::Show_Edges_Roots( )
	{
		float * angDifBuf = m_angDifData->GetData();
...
//			)->GetPixAt(0, 0);
	...
	void ScanTryMgr_4::DspLineOnImg( int a_x, int a_y,
...
//--		F32ImageRef dspImg = m_src->Clone();
	...
	ScanTryMgr_4::ScanTryMgr_4( int a_x, int a_y )
	{
...
//--		PrepareEnv( GlobalStuff::GetLinePathImg() );
	...
	ScanTryMgr_4::ScanTryMgr_4( IImgDataMgrRef a_src )
	{
		//m_nDiameter = GlobalStuff::AprSize1D;
...
*/
	...
	void ScanTryMgr_4::ScanSli( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		//PrepareAperSizes();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_4::GetEI_Of_Pix( int a_x, int a_y,
		int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_4::GetEI_Of_Pix( int a_nPI, int a_nDir )
	{
	...
	void ScanTryMgr_4::ScanPntDir( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
	...
	void ScanTryMgr_4::Find_Edges_Roots( int a_x, int a_y )
	{
		ImgGradMgr_2 & igm1 = *m_imgGradMgr;
		//ImgAvgingMgr & igm1 = *m_imgGradMgr;
	...
	void ScanTryMgr_4::PostProcScanLine( Ns_ImgGradMgr::ScanLineItrRef a_sli,
...
///////////----------------------------------------------
...

			{
				...
				int nIOA_Med1 = ioa_Buf[ rEI.Med1_IOL ];
				...
				for( int j = rEI.InrR1_IOL; j <= rEI.EdgeIOL; j++ )
				{
					...
					if( NULL == *ppEI_J )
					{
						*ppEI_J = & rEI;
						...
						rPI.nIOA_OfMax_EI_Med = nIOA_Med1;
					}
					else
					{
...

			{
				...
				int nIOA_Med2 = ioa_Buf[ rEI.Med2_IOL ];
				...
				for( int j = rEI.InrR2_IOL; j >= rEI.EdgeIOL; j-- )
				{
					...
					if( NULL == *ppEI_J )
					{
						*ppEI_J = & rEI;
						rPI.nIOA_OfMax_EI_R = nIOA_R;
						rPI.nIOA_OfMax_EI_Med = nIOA_Med2;
					}
					else
					{
						//if( rEI.StandDiv_E > (*ppEI_J)->StandDiv_E )
...
DoesConflict_Done:
	...
	EdgeScanMgr::DataDraw * ScanTryMgr_4::AddSigDraw( ISingFilt1D2Ref a_filt, 
	...
	void ScanTryMgr_4::PrepareFiltSys()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_4::PrepareFiltSys_Thesis()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_4::PrepareFiltSys_2()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_4::PrepareAperSizes()
	{
	...
	void ScanTryMgr_4::PrepareDeepRoots()
	{
		//int nDeepCnt = 1;
		int nDeepCnt = 2;
		//int nDeepCnt = 7;
	...
	void ScanTryMgr_4::PostProcessEI_Arr_2()
	{
		PrepareDeepRoots();
...
////////////////////////////////////////////////////////////////////////////////
	...
	F32ImageRef ScanTryMgr_4::GenSlopeImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_4::GenFinDifImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_4::GenMaxSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_4::GenMinSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
