...
namespace Hcv
{
	...
	namespace Ns_Saica
	{
		...
		SaicaProcess1::SaicaProcess1(F32ImageRef a_srcImg, float a_angDig)
		{
		...
		int SaicaProcess1::AddRound(int a_num)
		{
			int nRet;
		...
		int SaicaProcess1::AddRoundByMin(int a_num)
		{
			int nRet;
		...
		//void SaicaProcess1::PrepareProvArr()
		void SaicaProcess1::PrepareImageItrMgr()
		{
		...
		void SaicaProcess1::PrepareResImg()
		{
			int * resToSrcBuf = (int *)m_resToSrcMapImg->GetPixAt(0, 0);
