...
namespace Hcv
{
	...
	class CircleContourOfPix2 : FRM_Object
	{
	public:

		CircleContourOfPix2( F32ImageRef a_srcImg, F32ImageRef a_gradImg, int a_radius );
	...
	typedef Hcpl::ObjRef< CircleContourOfPix2 > CircleContourOfPix2Ref;
