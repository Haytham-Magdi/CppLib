...
namespace Hcv
{
	...
	RegionSegmentor5::RegionSegmentor5(S16ImageRef a_src, int a_nDifThreshold) : 
	...
	void RegionSegmentor5::InitRgnInfoVect(void)
	{
	...
	inline void RegionSegmentor5::CreateLink( RgnInfo * a_pRgn, 
	...
	void RegionSegmentor5::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor5::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor5::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor5::UpdateMasterRgn( 
	...
	int RegionSegmentor5::CalcColorDif( 
...
/*	int RegionSegmentor5::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
		int nDist = (int) sqrt( (double) (
	...
	int RegionSegmentor5::CalcRgnMeanDif(RgnInfo * a_pActRgn1, RgnInfo * a_pActRgn2)
	{
		int nDist = (int) sqrt( (double) (
	...
	void RegionSegmentor5::_RgnInfo::UpdateActRgn()
	{
		RgnInfo * a_pRgn = this;
	...
	S16ImageRef RegionSegmentor5::GenSegmentedImage(void)
	{
...
/*		for(int i=0; i < m_rgnInfoVect.size(); i++)
	...
	void RegionSegmentor5::PrepareConflicts()
	{
		// To be Revised
...
//				pRgn = pRgn;
	...
	void RegionSegmentor5::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor5::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
	...
	void RegionSegmentor5::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor5::PrepareRgnLinkActions( RgnInfo * a_pRgn )
	{
	...
	S16ImageRef RegionSegmentor5::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	S32ColorVal RegionSegmentor5::GetLocalMeanColor( 
	...
	S32ColorVal RegionSegmentor5::_RgnInfo::GetLocalMeanColor()
	{
		S32ColorVal ret;
