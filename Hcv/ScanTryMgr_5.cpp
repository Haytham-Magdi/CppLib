...
namespace Hcv
{
	...
	void ScanTryMgr_5::PrepareEnv( IImgDataMgrRef a_src, int a_nDif_Diameter )
	{
	...
	void ScanTryMgr_5::FillLineData( Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		a_sli->GotoFirst();
...
//uuuuuuuuuuuuuuuuuu
	...
	void ScanTryMgr_5::Show_Edges_Roots( )
	{
		float * angDifBuf = m_angDifData->GetData();
...
//			)->GetPixAt(0, 0);
	...
	void ScanTryMgr_5::DspLineOnImg( int a_x, int a_y,
...
//--		F32ImageRef dspImg = m_src->Clone();
	...
	//void ScanTryMgr_5::ValidateDiameter( int a_nDiameter )
	void ScanTryMgr_5::ValidateDiameter( )
	{
	...
	ScanTryMgr_5::ScanTryMgr_5( int a_x, int a_y )
	{
...
//--		PrepareEnv( GlobalStuff::GetLinePathImg() );
	...
	ScanTryMgr_5::ScanTryMgr_5( IImgDataMgrRef a_src, int a_nDiameter )
	{
		//m_nDiameter = GlobalStuff::AprSize1D;
...
*/
	...
	void ScanTryMgr_5::ScanSli( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		//PrepareAperSizes();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_5::GetEI_Of_Pix( int a_x, int a_y,
		int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_5::GetEI_Of_Pix( int a_nPI, int a_nDir )
	{
	...
	void ScanTryMgr_5::ScanPntDir( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
	...
	void ScanTryMgr_5::Find_Edges_Roots( int a_x, int a_y )
	{
		ImgGradMgr_2 & igm1 = *m_imgGradMgr;
		//ImgAvgingMgr & igm1 = *m_imgGradMgr;
	...
	void ScanTryMgr_5::PostProcScanLine( Ns_ImgGradMgr::ScanLineItrRef a_sli,
...
DoesConflict_Done:
	...
	EdgeScanMgr::DataDraw * ScanTryMgr_5::AddSigDraw( ISingFilt1D2Ref a_filt, 
	...
	void ScanTryMgr_5::PrepareFiltSys()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_5::PrepareFiltSys_Thesis()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_5::PrepareFiltSys_Thesis_2()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_5::PrepareFiltSys_2()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_5::PrepareAperSizes()
	{
	...
	void ScanTryMgr_5::PrepareDeepRoots()
	{
		//int nDeepCnt = 1;
		int nDeepCnt = 2;
		//int nDeepCnt = 7;
	...
	void ScanTryMgr_5::PostProcessEI_Arr_2()
	{
		PrepareDeepRoots();
...
////////////////////////////////////////////////////////////////////////////////
	...
	F32ImageRef ScanTryMgr_5::GenSlopeImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_5::GenFinDifImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_5::GenMaxSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_5::GenMinSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
