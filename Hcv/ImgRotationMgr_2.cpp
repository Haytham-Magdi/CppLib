...
namespace Hcv
{
	...
	ImgRotationMgr_2::ImgRotationMgr_2(F32ImageRef a_srcImg, float a_angDig)
	{
	...
	int ImgRotationMgr_2::AddRound(int a_num)
	{
		int nRet;
	...
	int ImgRotationMgr_2::AddRoundByMin(int a_num)
	{
		int nRet;
	...
	//void ImgRotationMgr_2::PrepareProvArr()
	void ImgRotationMgr_2::PrepareImageItrMgr()
	{
