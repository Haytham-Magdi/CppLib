...
namespace Hcv
{
	...
	//RegionSegmentor26::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor26::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor26::RegionSegmentor26(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor26::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor26::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor26::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor26::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor26::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor26::Segment()
	{
...
*/
	...
	float RegionSegmentor26::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor26::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor26::GenSegmentedImage( bool a_bShowMeanColor )
	{
	...
	F32ImageRef RegionSegmentor26::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor26::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor26::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor26::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	RegionSegmentor26::LinkAction * RegionSegmentor26::CloneLinkAction(LinkAction * a_pLA )
	{
		LinkAction * pLA = &m_linkActionVect[ m_nofLinkActions++ ];
	...
	RegionSegmentor26::LinkAction * RegionSegmentor26::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		ThrowHcvException();
...
*/
	...
	void RegionSegmentor26::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
			RgnLink & a_rLink, RgnLink & a_rLink2, float a_distBef, bool a_bSetProcessed )
	{
		...
		{		
			float distRoot = CalcRgnDif( a_pRgn->GetRootRgn(), a_pRgn2 );
			...
			{
				float srcGradV = *m_srcGrad->GetPixAt( a_pRgn->pos.x, a_pRgn->pos.y );
				float dstGradV = *m_srcGrad->GetPixAt( a_pRgn2->pos.x, a_pRgn2->pos.y );
/*	
	...
	bool RegionSegmentor26::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor26::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor26::RgnConflict * RegionSegmentor26::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor26::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor26::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor26::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor26::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor26::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor26::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor26::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor26::ScanImageLines()
	{
...
/////////////////////////
	...
	void RegionSegmentor26::FilterByLocalGrad()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	F32ImageRef RegionSegmentor26::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor26::GenNearEdgeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor26::GenBadRootImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	void RegionSegmentor26::PrepareLocalGrad( )
	{
	...
	void RegionSegmentor26::FilterByNearEdgeRoots()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	void RegionSegmentor26::MarkNearEdgeRgns()
	{
...
*/
	...
	void RegionSegmentor26::MarkNearEdgeRgns2()
	{
		static int dxArr[] = {1, 1, 0, -1};
		static int dyArr[] = {0, 1, 1, 1};
...
*/
	...
	RegionSegmentor26::RgnInfo * RegionSegmentor26::GetDeepValleyRgn( RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		{
			F32Point p1( 105, 105 );
...
Finish:
	...
	bool RegionSegmentor26::GetNextValleyRgn( RgnInfo * a_pRgn, RgnInfo ** a_ppOutRgn, 
	...
	void RegionSegmentor26::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	F32ImageRef RegionSegmentor26::GenBadEdgeImage()
	{
...
*/					
	...
	F32ImageRef RegionSegmentor26::GenLocalGradValImage()
	{
		//F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor26::GenLocalGradImage()
	{
...
*/
	...
	void RegionSegmentor26::AssignTraceIntersections()
	{
		static int dxArr[] = {1, 1, 0, -1};
		static int dyArr[] = {0, 1, 1, 1};
	...
	F32ImageRef RegionSegmentor26::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor26::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor26::PrepareValidEdgeDirs()
	{
		const int nRadius = 4;
	...
	void RegionSegmentor26::AssignBadRoots()
	{
	...
	RegionSegmentor26::BadRootAssignMgr::BadRootAssignMgr( RegionSegmentor26 * a_pSegmentor ) :
	...
	void RegionSegmentor26::BadRootAssignMgr::Proceed()
	{
		ScanImageLines();
	...
	void RegionSegmentor26::BadRootAssignMgr::ScanImageLines()
	{
		//CvSize siz1 = m_src->GetSize();
		CvSize siz1 = m_pSegmentor->m_maxPostDiffImg->GetSize();
		//CvSize siz1 = ( (RegionSegmentor26 *) m_pSegmentor)->m_maxPostDiffImg->GetSize();
...
/////////  NeDiag
	...
	void RegionSegmentor26::BadRootAssignMgr::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	void RegionSegmentor26::BadRootAssignMgr::MarkNearPeakRgns()
	{
