...
namespace Hcv
{
	...
	class ScanTryMgr_3 : public virtual EdgeScanMgr
	{
	public:
	...
	public:
		...
		ScanTryMgr_3( int a_x, int a_y );

//--		ScanTryMgr_3( F32ImageRef a_src );
		ScanTryMgr_3( IImgDataMgrRef a_src );
	...
	typedef Hcpl::ObjRef< ScanTryMgr_3 > ScanTryMgr_3Ref;
