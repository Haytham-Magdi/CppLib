...
namespace Hcv
{
	...
	class RegionSegmentor16 : FRM_Object
	{
	protected:
	...
	public:
		RegionSegmentor16(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		inline bool IsConflictDist(int a_nDist)
		{
			...
			return  ( a_nDist >= (m_nDifThreshold * m_difScale) );
		}
	...
	typedef Hcpl::ObjRef< RegionSegmentor16 > RegionSegmentor16Ref;
}