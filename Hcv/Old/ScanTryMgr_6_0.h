...
namespace Hcv
{
	...
	class ScanTryMgr_6 : public virtual EdgeScanMgr
	{
	public:
	...
	public:
		...
		ScanTryMgr_6( int a_x, int a_y );

//--		ScanTryMgr_6( F32ImageRef a_src );
		ScanTryMgr_6( IImgDataMgrRef a_src, int a_nDiameter );
	...
	protected:
		...
		ISingFilt1D2DataMgrRef m_stDivLocData;
	...
	typedef Hcpl::ObjRef< ScanTryMgr_6 > ScanTryMgr_6Ref;
