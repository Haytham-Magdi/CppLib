...
namespace Hcv
{
	...
	class ScanTryMgr_5 : public virtual EdgeScanMgr
	{
	public:
	...
	public:
		...
		ScanTryMgr_5( int a_x, int a_y );

//--		ScanTryMgr_5( F32ImageRef a_src );
		ScanTryMgr_5( IImgDataMgrRef a_src, int a_nDiameter );
	...
	typedef Hcpl::ObjRef< ScanTryMgr_5 > ScanTryMgr_5Ref;
