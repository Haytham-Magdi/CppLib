...
namespace Hcv
{
	...
	class RegionSegmentor15 : FRM_Object
	{
	protected:
	...
	public:
		RegionSegmentor15(S16ImageRef a_src, S16ImageRef a_rootImg,
			int a_nDifThreshold = 15, S16ImageRef a_rootValImg = NULL);
	...
	protected:
		...
		// With Space
		inline int CalcRgnDifWS(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2);
		...
		inline void PrepareRgnLinkActions( RgnInfo * a_pRgn, int a_nDistBef );
	...
	typedef Hcpl::ObjRef< RegionSegmentor15 > RegionSegmentor15Ref;
}