...
namespace Hcv
{
	...
	void ScanTryMgr_8::PrepareEnv( IImgDataMgrRef a_src, int a_nDif_Diameter )
	{
	...
	void ScanTryMgr_8::FillLineData( Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		a_sli->GotoFirst();
...
//uuuuuuuuuuuuuuuuuu
	...
	void ScanTryMgr_8::Show_Edges_Roots( )
	{
		float * angDifBuf = m_angDifData->GetData();
...
//			)->GetPixAt(0, 0);
	...
	void ScanTryMgr_8::DspLineOnImg( int a_x, int a_y,
...
//--		F32ImageRef dspImg = m_src->Clone();
	...
	//void ScanTryMgr_8::ValidateDiameter( int a_nDiameter )
	void ScanTryMgr_8::ValidateDiameter( )
	{
	...
	ScanTryMgr_8::ScanTryMgr_8( int a_x, int a_y )
	{
...
//--		PrepareEnv( GlobalStuff::GetLinePathImg() );
	...
	ScanTryMgr_8::ScanTryMgr_8( IImgDataMgrRef a_src, int a_nDiameter )
	{
		//m_nDiameter = GlobalStuff::AprSize1D;
...
*/
	...
	void ScanTryMgr_8::ScanSli( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		//PrepareAperSizes();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_8::GetEI_Of_Pix( int a_x, int a_y,
		int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_8::GetEI_Of_Pix( int a_nPI, int a_nDir )
	{
	...
	void ScanTryMgr_8::ScanPntDir( int a_x, int a_y,
			Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
	...
	void ScanTryMgr_8::Find_Edges_Roots( int a_x, int a_y )
	{
		ImgGradMgr_2 & igm1 = *m_imgGradMgr;
		//ImgAvgingMgr & igm1 = *m_imgGradMgr;
	...
	void ScanTryMgr_8::PostProcScanLine( Ns_ImgGradMgr::ScanLineItrRef a_sli,
...
DoesConflict_Done:
	...
	EdgeScanMgr::DataDraw * ScanTryMgr_8::AddSigDraw( ISingFilt1D2Ref a_filt, 
	...
	void ScanTryMgr_8::PrepareFiltSys()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_8::PrepareFiltSys_Thesis()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_8::PrepareFiltSys_Thesis_2()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_8::PrepareFiltSys_2()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
...
///////////////////////
	...
	void ScanTryMgr_8::PrepareAperSizes()
	{
	...
	void ScanTryMgr_8::PrepareDeepRoots()
	{
		//int nDeepCnt = 0;
//		int nDeepCnt = 1;
		int nDeepCnt = 2;
	...
	void ScanTryMgr_8::PostProcessEI_Arr_2()
	{
		PrepareDeepRoots();
...
////////////////////////////////////////////////////////////////////////////////
	...
	F32ImageRef ScanTryMgr_8::GenSlopeImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_8::GenFinDifImg( int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_8::GenMaxSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
	...
	F32ImageRef ScanTryMgr_8::GenMinSlopeImg()
	{
		CvSize srcSiz = m_src->GetSize();
