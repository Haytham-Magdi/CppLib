...
/*
	class IRegionSegmentor23 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor23 > IRegionSegmentor23Ref;
*/


	class RegionSegmentor23 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
	...
	public:
		RegionSegmentor23(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor23::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor23::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor23 > RegionSegmentor23Ref;
}