...
namespace Hcv
{
	...
	//RegionSegmentor27::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor27::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor27::RegionSegmentor27(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor27::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor27::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor27::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor27::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor27::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor27::Segment()
	{
...
*/
	...
	float RegionSegmentor27::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor27::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor27::GenSegmentedImage( bool a_bShowMeanColor )
	{
	...
	F32ImageRef RegionSegmentor27::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor27::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor27::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor27::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	RegionSegmentor27::LinkAction * RegionSegmentor27::CloneLinkAction(LinkAction * a_pLA )
	{
		LinkAction * pLA = &m_linkActionVect[ m_nofLinkActions++ ];
	...
	RegionSegmentor27::LinkAction * RegionSegmentor27::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		ThrowHcvException();
...
*/
	...
	void RegionSegmentor27::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
...
/*	
	...
	bool RegionSegmentor27::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor27::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor27::RgnConflict * RegionSegmentor27::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor27::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor27::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor27::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor27::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor27::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor27::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor27::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor27::ScanImageLines()
	{
...
*/
	...
	void RegionSegmentor27::FilterByLocalGrad()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	F32ImageRef RegionSegmentor27::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor27::GenNearEdgeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor27::GenBadRootImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	void RegionSegmentor27::PrepareLocalGrad( )
	{
	...
	void RegionSegmentor27::FilterByNearEdgeRoots()
	{
		for( int k=0; k < m_edgeInfoVect.GetSize(); k++ )
		{
			EdgeInfo & rEI = m_edgeInfoVect[ k ];
	...
	void RegionSegmentor27::MarkNearEdgeRgns()
	{
...
*/
	...
	void RegionSegmentor27::MarkNearEdgeRgns2()
	{
		static int dxArr[] = {1, 1, 0, -1};
		static int dyArr[] = {0, 1, 1, 1};
...
*/
	...
	RegionSegmentor27::RgnInfo * RegionSegmentor27::GetDeepValleyRgn( RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		{
			F32Point p1( 105, 105 );
...
*/
	...
	bool RegionSegmentor27::GetNextValleyRgn( RgnInfo * a_pRgn, RgnInfo ** a_ppOutRgn, 
	...
	void RegionSegmentor27::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	F32ImageRef RegionSegmentor27::GenBadEdgeImage()
	{
...
*/					
	...
	F32ImageRef RegionSegmentor27::GenLocalGradValImage()
	{
		//F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor27::GenLocalGradImage()
	{
...
*/
	...
	void RegionSegmentor27::AssignTraceIntersections()
	{
		static int dxArr[] = {1, 1, 0, -1};
		static int dyArr[] = {0, 1, 1, 1};
	...
	F32ImageRef RegionSegmentor27::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor27::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor27::PrepareValidEdgeDirs()
	{
		const int nRadius = 4;
	...
	void RegionSegmentor27::AssignBadRoots()
	{
	...
	RegionSegmentor27::BadRootAssignMgr::BadRootAssignMgr( RegionSegmentor27 * a_pSegmentor ) :
	...
	void RegionSegmentor27::BadRootAssignMgr::Proceed()
	{
		ScanImageLines();
	...
	void RegionSegmentor27::BadRootAssignMgr::ScanImageLines()
	{
		//CvSize siz1 = m_src->GetSize();
		CvSize siz1 = m_pSegmentor->m_maxPostDiffImg->GetSize();
		//CvSize siz1 = ( (RegionSegmentor27 *) m_pSegmentor)->m_maxPostDiffImg->GetSize();
...
/////////  NeDiag
	...
	void RegionSegmentor27::BadRootAssignMgr::ProcessLineScanResult( RgnLinkDir a_dir )
	{
...
*/
	...
	void RegionSegmentor27::BadRootAssignMgr::MarkNearPeakRgns()
	{
