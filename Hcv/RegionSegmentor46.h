...
/*
	class IRegionSegmentor46 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor46 > IRegionSegmentor46Ref;
*/


	class RegionSegmentor46 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		public:
			...
			EdgeInfoAccessor( RegionSegmentor46 * a_pSgm )
			{
				m_pSgm = a_pSgm;
	...
	public:
		RegionSegmentor46(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor46::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor46::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor46 > RegionSegmentor46Ref;
}