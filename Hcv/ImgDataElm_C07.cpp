...
namespace Hcv
{
	...
	int ImgDataElm_C07::NofColors = IMGDATAELM_C07_NOFCOLORS; 
	
	ImgDataElm_C07_ConverterRef ImgDataElm_C07::m_converter;



	ImgDataElm_C07_Converter::ImgDataElm_C07_Converter()
	{
		Init();
	}

	void ImgDataElm_C07_Converter::Init()
	{
		F32ColorVal c1;
		...
		if( m_mainColorArr.GetSize() < ImgDataElm_C07::GetNofColors() )
		{
		...
		while( m_mainColorArr.GetSize() < ImgDataElm_C07::GetNofColors() )
		{
			c1.AssignVal( 255, 0, 0 );
			m_mainColorArr.PushBack( c1 );
			m_dispColorArr.PushBack( c1 );
	...
	void ImgDataElm_C07_Converter::Convert( F32ColorVal & a_rSrc, ImgDataElm_C07 * a_pDst )
	{
		a_pDst->SetZeroVal();

		int nLim = ( ImgDataElm_C07::GetNofColors() < m_mainColorArr.GetSize() ) ?
			ImgDataElm_C07::GetNofColors() : m_mainColorArr.GetSize();
	...
	//float ImgDataElm_C07::Get_FarUnitDif()
