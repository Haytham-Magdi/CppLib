...
namespace Hcv
{
	...
	void ScanTryMgr_3::PrepareEnv( IImgDataMgrRef a_src, int a_nDif_Diameter )
	{
	...
	void ScanTryMgr_3::FillLineData( Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		a_sli->GotoFirst();
...
*/
	...
	EdgeScan::EdgeInfo * ScanTryMgr_3::GetEI_Of_Pix( int a_x, int a_y,
		int a_nDir )
	{
		CvSize srcSiz = m_src->GetSize();
	...
	EdgeScan::EdgeInfo * ScanTryMgr_3::GetEI_Of_Pix( int a_nPI, int a_nDir )
	{
	...
	void ScanTryMgr_3::PostProcScanLine( Ns_ImgGradMgr::ScanLineItrRef a_sli,
...
//////////////////////////////////////////////////////////////////
					...
					{
						float * standDiv_Buf = m_src->GetStandDiv_Mag_Image(
							)->GetPixAt(0, 0);

						float standDev_E = standDiv_Buf[nIOA_E];
						float standDev_1 = standDiv_Buf[nIOA_R1];
						float standDev_2 = standDiv_Buf[nIOA_R2];
...
//--				edgeVal = F32ColorVal::Sub( rColorR1, rColorR2 ).CalcMag();				
					edgeVal = m_src->CalcDif( nIOA_R1, nIOA_R2 );
			}
