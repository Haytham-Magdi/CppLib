...
/*
	class IRegionSegmentor26 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor26 > IRegionSegmentor26Ref;
*/


	class RegionSegmentor26 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		{
		public:
			BadRootAssignMgr( RegionSegmentor26 * a_pSegmentor );
		...
		protected:
			...
			//const RegionSegmentor26 * m_pSegmentor;
			RegionSegmentor26 * m_pSegmentor;
	...
	public:
		RegionSegmentor26(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor26::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor26::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor26 > RegionSegmentor26Ref;
}