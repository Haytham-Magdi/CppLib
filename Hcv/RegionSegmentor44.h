...
/*
	class IRegionSegmentor44 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor44 > IRegionSegmentor44Ref;
*/


	class RegionSegmentor44 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		public:
			...
			EdgeInfoAccessor( RegionSegmentor44 * a_pSgm )
			{
				m_pSgm = a_pSgm;
	...
	public:
		RegionSegmentor44(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor44::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor44::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor44 > RegionSegmentor44Ref;
}