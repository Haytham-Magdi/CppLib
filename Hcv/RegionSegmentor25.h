...
/*
	class IRegionSegmentor25 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor25 > IRegionSegmentor25Ref;
*/


	class RegionSegmentor25 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		{
		public:
			BadRootAssignMgr( RegionSegmentor25 * a_pSegmentor );
		...
		protected:
			...
			//const RegionSegmentor25 * m_pSegmentor;
			RegionSegmentor25 * m_pSegmentor;
	...
	public:
		RegionSegmentor25(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor25::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor25::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor25 > RegionSegmentor25Ref;
}