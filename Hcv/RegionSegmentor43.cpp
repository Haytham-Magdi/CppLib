...
namespace Hcv
{
	...
	//RegionSegmentor43::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor43::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor43::RegionSegmentor43(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor43::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor43::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor43::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor43::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor43::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor43::Segment()
	{
		//m_pDbgRgn = & m_rgnInfoVect[ 110507 ];
...
//if( e < nLim_e - 1 )
	...
	float RegionSegmentor43::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor43::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor43::GenSegmentedImage( bool a_bShowMeanColor )
	{
	...
	F32ImageRef RegionSegmentor43::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor43::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor43::ShowSrcPath(int a_x, int a_y)
	{
		//a_x = 266;
		//a_y = 426;
	...
	void RegionSegmentor43::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor43::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	//RegionSegmentor43::LinkAction * RegionSegmentor43::CloneLinkAction(LinkAction * a_pLA )
	//{
	...
	RegionSegmentor43::LinkAction * RegionSegmentor43::ProvideLinkAction( 
		//RegionSegmentor43::RgnInfo * a_pRgn, RegionSegmentor43::RgnInfo * a_pRgn2 )
	...
	RegionSegmentor43::LinkAction * RegionSegmentor43::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		//ThrowHcvException();
	...
	void RegionSegmentor43::PrepareLinkAction( 
...
*/
	...
	void RegionSegmentor43::Push_LA_To_MergeQues( int a_nIndex, LinkAction * pLA )
	{
		pLA->bIsActive = true;
	...
	RegionSegmentor43::LinkAction * RegionSegmentor43::PopMinPtr_From_MergeQues()
	{
		PopPtr:
	...
	RegionSegmentor43::LinkAction * RegionSegmentor43::PopMaxPtr_From_MergeQues()
	{
		PopPtr:
	...
	bool RegionSegmentor43::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor43::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor43::RgnConflict * RegionSegmentor43::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor43::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor43::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor43::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor43::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor43::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge, EdgeScan::EdgeInfo * a_pEI )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor43::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor43::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor43::ScanImageLines()
	{
...
/////////--------------------------------------------
	...
	RegionSegmentor43::RgnLink * RegionSegmentor43::GetLinkBetweenRgns( int a_nIdx_1, int a_nIdx_2 )
	{
	...
	F32ImageRef RegionSegmentor43::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor43::GenBadSrcImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor43::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor43::GenTraceDamImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor43::GenRgnRootDifImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	void RegionSegmentor43::ResetBadSrcWork()
	{
		Hcpl_ASSERT( false );
	...
	void RegionSegmentor43::MarkRgnsFromBadSrc()
	{
		RgnInfo * pTestRgn = & m_rgnInfoVect[ m_nTestRgnIdx ];
...
//*/
	...
	F32ImageRef RegionSegmentor43::Gen_FalseMergeImage_2()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor43::Gen_FalseMergeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor43::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor43::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor43::Manage_EI_Activation( RgnInfo * a_pRgn_1, RgnInfo * a_pRgn_2 )
	{
		//return;
