...
namespace Hcv
{
	...
	RegionSegmentor11::RegionSegmentor11(S16ImageRef a_src, S16ImageRef a_rootImg,
		int a_nDifThreshold) : 
	...
	void RegionSegmentor11::InitRgnInfoVect(void)
	{
	...
	inline void RegionSegmentor11::CreateLink( RgnInfo * a_pRgn, 
	...
	void RegionSegmentor11::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor11::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor11::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor11::Segment()
	{
		int nMaxConfCnt = 0;
...
NoConflict:
	...
	int RegionSegmentor11::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor11::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor11::GenSegmentedImage(void)
	{
...
/*
	void RegionSegmentor11::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	void RegionSegmentor11::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor11::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		bool bRet = false;
	...
	void RegionSegmentor11::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor11::PrepareRgnLinkActions( RgnInfo * a_pRgn )
	{
		...
		for(int i=0; i<4; i++)
		{
			...
			if( -1 == rLink.nDist )
			{
				rLink.nDist = rLink2.nDist =
					CalcRgnDif( a_pRgn->pRootRgn, pRgn2 );
			}
	...
	S16ImageRef RegionSegmentor11::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor11::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2 )
	{
