...
namespace Hcv
{
	...
	RegionSegmentor8::RegionSegmentor8(S16ImageRef a_src, int a_nDifThreshold) : 
	m_rgnIndexCalc(a_src->GetWidth(), a_src->GetHeight()), m_nPreMergeDif( 0 )
	{	
	...
	void RegionSegmentor8::InitRgnInfoVect(void)
	{
		m_rgnInfoVect.resize(m_src->GetWidth() * m_src->GetHeight());
		m_nofRgns = m_rgnInfoVect.size();
	...
	inline void RegionSegmentor8::CreateLink( RgnInfo * a_pRgn, 
	...
	{	
		...
		if( nDist <= m_nPreMergeDif )
		{
			a_pRgn->UpdateActRgn();
			RgnInfo * pActRgn1 = a_pRgn->pActRgn;

			pRgn2->UpdateActRgn();
			RgnInfo * pActRgn2 = pRgn2->pActRgn;
			...
			UpdateMasterRgnNoConfs( pMasterRgn, pSlaveRgn );
...
/*		if(	IsConflictDist(	nDist ) )
	...
	void RegionSegmentor8::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor8::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor8::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor8::UpdateMasterRgnNoConfs( 
	...
	void RegionSegmentor8::UpdateMasterRgn( 
		RgnInfo * a_pMaster, RgnInfo * a_pSlave )
	{
		a_pMaster->conflictList.TakeListElements(
			a_pSlave->conflictList );

		UpdateMasterRgnNoConfs( a_pMaster, a_pSlave );
	}

	int RegionSegmentor8::CalcColorDif( 
...
/*	int RegionSegmentor8::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
		int nDist = (int) sqrt( (double) (
	...
	int RegionSegmentor8::CalcRgnMeanDif(RgnInfo * a_pActRgn1, RgnInfo * a_pActRgn2)
	{
		int nDist = (int) sqrt( (double) (
	...
	void RegionSegmentor8::_RgnInfo::UpdateActRgn()
	{
		RgnInfo * a_pRgn = this;
	...
	S16ImageRef RegionSegmentor8::GenSegmentedImage(void)
	{
...
/*		for(int i=0; i < m_rgnInfoVect.size(); i++)
	...
	void RegionSegmentor8::PrepareConflicts()
	{
		// To be Revised
...
//				pRgn = pRgn;
	...
	void RegionSegmentor8::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor8::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
	...
	void RegionSegmentor8::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor8::PrepareRgnLinkActions( RgnInfo * a_pRgn )
	{
	...
	S16ImageRef RegionSegmentor8::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	S32ColorVal RegionSegmentor8::GetLocalMeanColor( 
	...
	S32ColorVal RegionSegmentor8::_RgnInfo::GetLocalMeanColor()
	{
		S32ColorVal ret;
	...
	void RegionSegmentor8::PrepareFarConflicts( RgnInfo * a_pRgn, 
