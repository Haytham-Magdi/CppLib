...
namespace Hcv
{
	...
	public:
		...
		void Copy(ColorTryMgr & a_rElm)
		{
			Color = a_rElm.Color;
		}

		void IncBy(ColorTryMgr & a_rElm)
		{
			Color.IncBy(a_rElm.Color);
		}

		void DecBy(ColorTryMgr & a_rElm)
		{
			Color.DecBy(a_rElm.Color);
		}

		void CalcUnitElm(ColorTryMgr * a_pOut)
		{
			*a_pOut = *this;
		...
		static float CalcDif(ColorTryMgr & a_rElm_1, 
			ColorTryMgr & a_rElm_2)
		{
		...
		static float Calc_UnitDif(ColorTryMgr & a_rElm_1, 
			ColorTryMgr & a_rElm_2)
		{
			static ColorTryMgr ue_1;
			static ColorTryMgr ue_2;

			a_rElm_1.CalcUnitElm( & ue_1 );
			a_rElm_2.CalcUnitElm( & ue_2 );

			return ColorTryMgr::CalcDif(
				ue_1, ue_2);
		}
	...
	typedef Hcpl::ObjRef< ColorTryMgr > ColorTryMgrRef;
