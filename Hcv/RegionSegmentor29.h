...
/*
	class IRegionSegmentor29 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor29 > IRegionSegmentor29Ref;
*/


	class RegionSegmentor29 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		{
		public:
			BadRootAssignMgr( RegionSegmentor29 * a_pSegmentor );
		...
		protected:
			...
			//const RegionSegmentor29 * m_pSegmentor;
			RegionSegmentor29 * m_pSegmentor;
	...
	public:
		RegionSegmentor29(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor29::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor29::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor29 > RegionSegmentor29Ref;
}