...
namespace Hcv
{
	...
	class RegionSegmentor19 : FRM_Object
	{
//////////////////////////////////////////////////////////////
...
/*			struct _TraceUnit()
	...
	public:
		RegionSegmentor19(F32ImageRef a_src, S16ImageRef a_rootImg,
		...
		void Segment();
		S16ImageRef GenSegmentedImage(bool a_bShowMeanColor = true);
	...
	protected:
		...
		std::vector<TraceUnit> m_edgeFwdRgnVect;
		std::vector<TraceUnit> m_edgeBkdRgnVect;
	...
	typedef Hcpl::ObjRef< RegionSegmentor19 > RegionSegmentor19Ref;
}