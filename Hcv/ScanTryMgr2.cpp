...
namespace Hcv
{
	...
	void ScanTryMgr2::FillLineData( Ns_ImgGradMgr::ScanLineItrRef a_sli )
	{
		a_sli->GotoFirst();
...
*/
	...
	void ScanTryMgr2::Find_Edges_Roots( int a_x, int a_y )
	{
		ImgGradMgr & igm1 = *m_imgGradMgr;
	...
	void ScanTryMgr2::PostProcScanLine( Ns_ImgGradMgr::ScanLineItrRef a_sli,
...
///////////////////////
	...
	void ScanTryMgr2::PrepareFiltSys_Thesis()
	{
		int nShiftY_1 = 100;
		int nShiftY_2 = 180;
