...
namespace Hcv
{
	...
	class RegionSegmentor8 : FRM_Object
	{
	protected:
	...
	public:
		RegionSegmentor8(S16ImageRef a_src, int a_nDifThreshold = 15);
	...
	protected:
		...
		inline void UpdateMasterRgnNoConfs( RgnInfo * a_pMaster, RgnInfo * a_pSlave );
	...
	protected:
		...
		int m_nDifIndex;
		int m_nVisitID;
		const int m_nPreMergeDif;
		int m_nofRgns;
	};


	typedef Hcpl::ObjRef< RegionSegmentor8 > RegionSegmentor8Ref;
}