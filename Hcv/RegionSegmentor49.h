...
/*
	class IRegionSegmentor49 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor49 > IRegionSegmentor49Ref;
*/


	class RegionSegmentor49 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		public:
			...
			EdgeInfoAccessor( RegionSegmentor49 * a_pSgm )
			{
				m_pSgm = a_pSgm;
	...
	public:
		RegionSegmentor49(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor49::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor49::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor49 > RegionSegmentor49Ref;
}