...
/*
	class IRegionSegmentor38 : FRM_Object
	{	
	public:
	...
	typedef Hcpl::ObjRef< IRegionSegmentor38 > IRegionSegmentor38Ref;
*/


	class RegionSegmentor38 : public IRegionSegmentor20
	{
//////////////////////////////////////////////////////////////
...
*/
		...
		public:
			...
			EdgeInfoAccessor( RegionSegmentor38 * a_pSgm )
			{
				m_pSgm = a_pSgm;
	...
	public:
		RegionSegmentor38(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	protected:
		...
		void RegionSegmentor38::AddFwdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
		void RegionSegmentor38::AddBkdTraceUnit(RgnInfo * a_pRgn, int a_nFwdIndex, int a_nBkdIndex);
	...
	typedef Hcpl::ObjRef< RegionSegmentor38 > RegionSegmentor38Ref;
}