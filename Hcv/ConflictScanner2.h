...
namespace Hcv
{
	...
	class ConflictScanner2 : public IColorFilter1DSystemConsumer
	{
	public:
	...
	protected:
		...
		{
		public:
			FilterOutputMgrBase( ConflictScanner2 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) : 
		...
		{
		public:
			DummyOutputMgr( ConflictScanner2 * a_pIlv ) : FilterOutputMgrBase( a_pIlv ) {}
		...
		{
		public:
			ColorOutputMgr( ConflictScanner2 * a_pIlv,
		...
		{
		public:
			AvgOutputMgr( ConflictScanner2 * a_pIlv ) : ColorOutputMgr( a_pIlv,
		...
		{
		public:
			SingleOutputMgr( ConflictScanner2 * a_pIlv, U8ColorVal a_color ) 
...
/*
		...
		{
		public:
			Diff1MarkerOutputMgr( ConflictScanner2 * a_pIlv, U8ColorVal a_color ) 
...
*/
		...
		{
		public:
			DebugOutputMgr( ConflictScanner2 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) 
		...
		{
		public:
			PostDiff1OutputMgr( ConflictScanner2 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) 
				: FilterOutputMgrBase( a_pIlv, a_inner ) {}
		...
		{
		public:
			LocalGradOutputMgr( ConflictScanner2 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) 
				: FilterOutputMgrBase( a_pIlv, a_inner ) {}
		...
		{
		public:
			Diff1MarkerOutputMgr( ConflictScanner2 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) 
				: FilterOutputMgrBase( a_pIlv, a_inner ) {}
		...
		{
		public:
			Diff2MarkerOutputMgr( ConflictScanner2 * a_pIlv, IFilterOutputMgrRef a_inner = NULL ) 
				: FilterOutputMgrBase( a_pIlv, a_inner ) {}
	...
	public:
		...
		ConflictScanner2( F32ImageRef a_srcImg );
	...
	typedef Hcpl::ObjRef< ConflictScanner2 > ConflictScanner2Ref;
