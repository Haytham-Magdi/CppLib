...
namespace Hcv
{
	...
	class ScanTryMgr_9 : public virtual EdgeScanMgr
	{
	public:
	...
	public:
		...
		ScanTryMgr_9( int a_x, int a_y );

//--		ScanTryMgr_9( F32ImageRef a_src );
		ScanTryMgr_9( IImgDataMgrRef a_src, int a_nDiameter );
	...
	protected:
		...
		FixedVector< int > m_PI_Path_1_Arr;
		FixedVector< int > m_PI_Path_2_Arr;
	...
	typedef Hcpl::ObjRef< ScanTryMgr_9 > ScanTryMgr_9Ref;
