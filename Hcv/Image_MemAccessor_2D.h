...
namespace Hcv
{
	...
	template<class T_ImgElm, class T_AccElm, int V_SupposedNofChannels>
	...
	public:
		...
		{
			m_srcImg = a_srcImg;
			Image_MemAccessor_2D::PrepareAccessorFromImage(m_srcImg, V_SupposedNofChannels, &m_memAccessor);
		}
