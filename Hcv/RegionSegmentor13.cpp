...
namespace Hcv
{
	...
	RegionSegmentor13::RegionSegmentor13(S16ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor13::InitRgnInfoVect(void)
	{
	...
	inline void RegionSegmentor13::CreateLink( RgnInfo * a_pRgn, 
	...
	void RegionSegmentor13::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor13::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor13::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor13::Segment()
	{
		int nMaxConfCnt = 0;
...
NoConflict:
	...
	int RegionSegmentor13::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor13::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor13::GenSegmentedImage(void)
	{
...
/*
	void RegionSegmentor13::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	void RegionSegmentor13::PrepareLinkAction( RgnInfo * a_pRgn, RgnInfo * a_pRgn2,
	...
	bool RegionSegmentor13::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		bool bRet = false;
	...
	void RegionSegmentor13::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor13::PrepareRgnLinkActions( RgnInfo * a_pRgn )
	{
	...
	S16ImageRef RegionSegmentor13::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor13::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2 )
	{
