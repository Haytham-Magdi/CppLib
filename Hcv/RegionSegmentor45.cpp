...
namespace Hcv
{
	...
	//RegionSegmentor45::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor45::RgnInfo::s_MergeOrder = 0;

	RegionSegmentor45::RegionSegmentor45(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor45::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor45::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor45::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor45::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor45::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor45::Segment()
	{
		//m_pDbgRgn = & m_rgnInfoVect[ 110507 ];
...
//if( e < nLim_e - 1 )
	...
	float RegionSegmentor45::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor45::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor45::GenSegmentedImage( bool a_bShowMeanColor )
	{
		//Gen_SegData();
	...
	F32ImageRef RegionSegmentor45::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor45::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor45::ShowSrcPath(int a_x, int a_y)
	{
		//a_x = 266;
		//a_y = 426;
	...
	void RegionSegmentor45::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor45::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	//RegionSegmentor45::LinkAction * RegionSegmentor45::CloneLinkAction(LinkAction * a_pLA )
	//{
	...
	RegionSegmentor45::LinkAction * RegionSegmentor45::ProvideLinkAction( 
		//RegionSegmentor45::RgnInfo * a_pRgn, RegionSegmentor45::RgnInfo * a_pRgn2 )
	...
	RegionSegmentor45::LinkAction * RegionSegmentor45::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		//ThrowHcvException();
	...
	void RegionSegmentor45::PrepareLinkAction( 
...
*/
	...
	void RegionSegmentor45::Push_LA_To_MergeQues( int a_nIndex, LinkAction * pLA )
	{
		pLA->bIsActive = true;
	...
	RegionSegmentor45::LinkAction * RegionSegmentor45::PopMinPtr_From_MergeQues()
	{
		PopPtr:
	...
	RegionSegmentor45::LinkAction * RegionSegmentor45::PopMaxPtr_From_MergeQues()
	{
		PopPtr:
	...
	bool RegionSegmentor45::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor45::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor45::RgnConflict * RegionSegmentor45::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor45::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor45::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor45::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor45::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor45::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge, EdgeScan::EdgeInfo * a_pEI )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor45::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor45::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor45::PostScanPrepare()
	{
	...
	void RegionSegmentor45::ScanImageLines()
	{
...
/////////--------------------------------------------
	...
	RegionSegmentor45::RgnLink * RegionSegmentor45::GetLinkBetweenRgns( int a_nIdx_1, int a_nIdx_2 )
	{
	...
	F32ImageRef RegionSegmentor45::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor45::GenBadSrcImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor45::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor45::GenTraceDamImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor45::GenRgnRootDifImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	void RegionSegmentor45::ResetBadSrcWork()
	{
		Hcpl_ASSERT( false );
	...
	void RegionSegmentor45::MarkRgnsFromBadSrc()
	{
		RgnInfo * pTestRgn = & m_rgnInfoVect[ m_nTestRgnIdx ];
...
//*/
	...
	F32ImageRef RegionSegmentor45::Gen_FalseMergeImage_2()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor45::Gen_FalseMergeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor45::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor45::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor45::Manage_EI_Activation( RgnInfo * a_pRgn_1, RgnInfo * a_pRgn_2 )
	{
		return;
	...
	void RegionSegmentor45::Gen_SegData()
	{
