...
namespace Hcv
{
	...
	//RegionSegmentor47::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor47::RgnInfo::s_MergeOrder = 0;


	RegionSegmentor47::~RegionSegmentor47()
	{
		m_imgDataMgr = NULL;
	}
	...
	RegionSegmentor47::RegionSegmentor47(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor47::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
	...
	inline void RegionSegmentor47::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor47::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor47::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor47::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor47::Segment()
	{
		//m_pDbgRgn = & m_rgnInfoVect[ 110507 ];
...
//if( e < nLim_e - 1 )
	...
	float RegionSegmentor47::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
	...
	void RegionSegmentor47::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor47::GenSegmentedImage( bool a_bShowMeanColor )
	{
		//Gen_SegData();
	...
	F32ImageRef RegionSegmentor47::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor47::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor47::ShowSrcPath(int a_x, int a_y)
	{
		//a_x = 266;
		//a_y = 426;
	...
	void RegionSegmentor47::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor47::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	//RegionSegmentor47::LinkAction * RegionSegmentor47::CloneLinkAction(LinkAction * a_pLA )
	//{
	...
	RegionSegmentor47::LinkAction * RegionSegmentor47::ProvideLinkAction( 
		//RegionSegmentor47::RgnInfo * a_pRgn, RegionSegmentor47::RgnInfo * a_pRgn2 )
	...
	RegionSegmentor47::LinkAction * RegionSegmentor47::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		//ThrowHcvException();
	...
	void RegionSegmentor47::PrepareLinkAction( 
...
*/
	...
	void RegionSegmentor47::Push_LA_To_MergeQues( int a_nIndex, LinkAction * pLA )
	{
		pLA->bIsActive = true;
	...
	RegionSegmentor47::LinkAction * RegionSegmentor47::PopMinPtr_From_MergeQues()
	{
		PopPtr:
	...
	RegionSegmentor47::LinkAction * RegionSegmentor47::PopMaxPtr_From_MergeQues()
	{
		PopPtr:
	...
	bool RegionSegmentor47::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor47::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor47::RgnConflict * RegionSegmentor47::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor47::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor47::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor47::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor47::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor47::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge, EdgeScan::EdgeInfo * a_pEI )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor47::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor47::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor47::PostScanPrepare()
	{
	...
	void RegionSegmentor47::ScanImageLines()
	{
...
/////////////////////////
		...
		m_scanTryMgr = new ScanTryMgr_6( m_imgDataMgr, m_nAprSize );
		//m_scanTryMgr = new ScanTryMgr_6( m_src );
...
/////////--------------------------------------------
	...
	RegionSegmentor47::RgnLink * RegionSegmentor47::GetLinkBetweenRgns( int a_nIdx_1, int a_nIdx_2 )
	{
	...
	F32ImageRef RegionSegmentor47::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor47::GenBadSrcImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor47::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor47::GenTraceDamImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor47::GenRgnRootDifImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	void RegionSegmentor47::ResetBadSrcWork()
	{
		Hcpl_ASSERT( false );
	...
	void RegionSegmentor47::MarkRgnsFromBadSrc()
	{
		RgnInfo * pTestRgn = & m_rgnInfoVect[ m_nTestRgnIdx ];
...
//*/
	...
	F32ImageRef RegionSegmentor47::Gen_FalseMergeImage_2()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor47::Gen_FalseMergeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor47::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor47::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor47::Manage_EI_Activation( RgnInfo * a_pRgn_1, RgnInfo * a_pRgn_2 )
	{
		return;
	...
	void RegionSegmentor47::Gen_SegData()
	{
