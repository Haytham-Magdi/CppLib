...
namespace Hcv
{
	...
	//RegionSegmentor48::MgrOfLinkTypes::CoreStuff m_core;

	int RegionSegmentor48::RgnInfo::s_MergeOrder = 0;


	RegionSegmentor48::~RegionSegmentor48()
	{
		m_imgDataMgr = NULL;
	}
	...
	RegionSegmentor48::RegionSegmentor48(F32ImageRef a_src, S16ImageRef a_rootImg,
	...
	void RegionSegmentor48::InitRgnInfoVect(void)
	{
...
/*		F32ChannelRef srcCh0 = m_src->GetAt(0);
		...
		m_imgDataMgr = new ImgDataMgr_C7(
		...
		ImgDataMgr_C7 * pDataMgr_Exact = dynamic_cast<ImgDataMgr_C7 *>
	...
	inline void RegionSegmentor48::CreateLink( RgnInfo * a_pRgn, 
...
*/
	...
	void RegionSegmentor48::InitLinks(void)
	{
	...
	S16ImageRef RegionSegmentor48::GenDifImg(bool a_bRC, bool a_bRB,
	...
	HistoGramRef RegionSegmentor48::GenDifHisto(bool a_bRC, bool a_bRB,
		bool a_bCB, bool a_bLB)
	{
	...
	void RegionSegmentor48::Segment()
	{
		//m_pDbgRgn = & m_rgnInfoVect[ 110507 ];
...
//if( e < nLim_e - 1 )
	...
	float RegionSegmentor48::CalcRgnDif(RgnInfo * a_pRgn1, RgnInfo * a_pRgn2)
	{
		...
		////dist = m_difScale * ImgDataElm_C7_2::CalcDif(
	...
	void RegionSegmentor48::UpdateActRgn(RgnInfo * a_pRgn)
	{
...
//			while(pActRgn != pActRgn->GetActRgn() && nofRgns < nMaxNofRgns)
	...
	S16ImageRef RegionSegmentor48::GenSegmentedImage( bool a_bShowMeanColor )
	{
		//Gen_SegData();
	...
	F32ImageRef RegionSegmentor48::GenSegmentedImage2( bool a_bShowMeanColor )
	{
	...
	void RegionSegmentor48::ShowValleyPath(int a_x, int a_y)
	{
	...
	void RegionSegmentor48::ShowSrcPath(int a_x, int a_y)
	{
		//a_x = 266;
		//a_y = 426;
	...
	void RegionSegmentor48::ShowEdgeOfConflict()
	{
...
/*
	void RegionSegmentor48::PrepareConflicts()
	{
...
//				pRgn = pRgn;
	...
	*/
	...
	//RegionSegmentor48::LinkAction * RegionSegmentor48::CloneLinkAction(LinkAction * a_pLA )
	//{
	...
	RegionSegmentor48::LinkAction * RegionSegmentor48::ProvideLinkAction( 
		//RegionSegmentor48::RgnInfo * a_pRgn, RegionSegmentor48::RgnInfo * a_pRgn2 )
	...
	RegionSegmentor48::LinkAction * RegionSegmentor48::ProvideLinkAction(RgnInfo * a_pRgn, RgnLinkDir a_dir )
	{
		// Hthm tmp
		//ThrowHcvException();
	...
	void RegionSegmentor48::PrepareLinkAction( 
...
*/
	...
	void RegionSegmentor48::Push_LA_To_MergeQues( int a_nIndex, LinkAction * pLA )
	{
		pLA->bIsActive = true;
	...
	RegionSegmentor48::LinkAction * RegionSegmentor48::PopMinPtr_From_MergeQues()
	{
		PopPtr:
	...
	RegionSegmentor48::LinkAction * RegionSegmentor48::PopMaxPtr_From_MergeQues()
	{
		PopPtr:
	...
	bool RegionSegmentor48::HaveConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		RegionSegmentor48::RgnConflict * pConflict = GetExistingConflict( a_pMinSizRgn, a_pMaxSizRgn);
	...
	RegionSegmentor48::RgnConflict * RegionSegmentor48::GetExistingConflict( RgnInfo * a_pMinSizRgn, RgnInfo * a_pMaxSizRgn)
	{
		//bool bRet = false;
		...
		RegionSegmentor48::RgnConflict * pConflict = minConfList.Last();
	...
	void RegionSegmentor48::RemoveDuplicateConflicts( RgnInfo * a_pRgn )
	{
	...
	void RegionSegmentor48::PrepareRgnLinkActions( RgnInfo * a_pRgn, float a_distBef )
	{
...
//			if( rLink.bProcessed )
	...
	S16ImageRef RegionSegmentor48::GenConflictImg(bool a_bRC, bool a_bRB,
			bool a_bCB, bool a_bLB)
	{
		S16ImageRef ret = S16Image::Create(m_src->GetSize(), 1);
		ret->SetAll(0);
	...
	void RegionSegmentor48::CreateConflict( RgnInfo * a_pRgn1, RgnInfo * a_pRgn2, RgnInfo * a_pOrgEdge, EdgeScan::EdgeInfo * a_pEI )
	{
		if( NULL == a_pOrgEdge )
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor48::MgrOfLinkTypes::CoreStuff::InitLinkTypeMgrs()
	{
	...
	void RegionSegmentor48::MgrOfLinkTypes::CoreStuff::InitMaps()
	{
		m_linkTypeMgrVect.SetSize(8);
...
//////////////////////////////////////////////////////////////
	...
	void RegionSegmentor48::PostScanPrepare()
	{
	...
	void RegionSegmentor48::ScanImageLines()
	{
...
/////////////////////////
		...
		m_scanTryMgr = new ScanTryMgr_7( m_imgDataMgr, m_nAprSize );
		//m_scanTryMgr = new ScanTryMgr_7( m_src );
...
/////////--------------------------------------------
	...
	RegionSegmentor48::RgnLink * RegionSegmentor48::GetLinkBetweenRgns( int a_nIdx_1, int a_nIdx_2 )
	{
	...
	F32ImageRef RegionSegmentor48::GenScanImage()
	{
...
/*				if( rEI.Dir != pRgn->localGradDir && pRgn->localGradVal > 0.5 )
	...
	F32ImageRef RegionSegmentor48::GenBadSrcImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	F32ImageRef RegionSegmentor48::GenRootRgnImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor48::GenTraceDamImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
...
*/
	...
	F32ImageRef RegionSegmentor48::GenRgnRootDifImage()
	{
		F32ImageRef ret = F32Image::Create( m_src->GetSize(), 3 );
	...
	void RegionSegmentor48::ResetBadSrcWork()
	{
		Hcpl_ASSERT( false );
	...
	void RegionSegmentor48::MarkRgnsFromBadSrc()
	{
		RgnInfo * pTestRgn = & m_rgnInfoVect[ m_nTestRgnIdx ];
...
//*/
	...
	F32ImageRef RegionSegmentor48::Gen_FalseMergeImage_2()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor48::Gen_FalseMergeImage()
	{
		F32ImageRef ret = this->m_src->Clone();
	...
	F32ImageRef RegionSegmentor48::GenMergeOrderImage()
	{
		F32ImageRef ret = this->m_src->Clone();
...
*/
	...
	void RegionSegmentor48::PrepareSrcGradImg()
	{
...
//		m_srcGrad = GenMorphGradImg( m_src, 2 );
	...
	void RegionSegmentor48::Manage_EI_Activation( RgnInfo * a_pRgn_1, RgnInfo * a_pRgn_2 )
	{
		return;
	...
	void RegionSegmentor48::Gen_SegData()
	{
